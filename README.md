...
- **10 Hour Bonus** — Week 38 routes with **180 or more completed stops** (148 routes: 16, 12, 13, 28, 28, 25, 26 by day from Sep 13–19). Names stay as captured, including multi-transporter routes. CSV and Excel export the full list. The table hides days outside the selected period.
