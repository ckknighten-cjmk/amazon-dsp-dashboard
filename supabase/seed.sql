...
insert into public.vehicle_dvics (
  id, vehicle_id, driver_id, station_id, service_date, shift_type, inspected_at, status, odometer_miles, prior_dvic_id, notes, comparison_status, comparison_model, compared_at
) values
  ('e0000000-0000-4000-8000-000000000101', 'c0000000-0000-4000-8000-000000000001', 'b0000000-0000-4000-8000-000000001042', 'a0000000-0000-4000-8000-000000000001', '2026-09-14', 'pre_trip', '2026-09-14 06:18+00', 'pass', 14850, null, 'Baseline pre-trip. All zones clear.', 'skipped', null, null),
  ('e0000000-0000-4000-8000-000000000102', 'c0000000-0000-4000-8000-000000000001', 'b0000000-0000-4000-8000-000000001088', 'a0000000-0000-4000-8000-000000000001', '2026-09-19', 'post_trip', '2026-09-19 18:42+00', 'pass', 15210, 'e0000000-0000-4000-8000-000000000101', 'Kwame returned EV-210. Door clear.', 'compared', 'damage-clip-v1', '2026-09-19 18:44+00'),
  ('e0000000-0000-4000-8000-000000000103', 'c0000000-0000-4000-8000-000000000001', 'b0000000-0000-4000-8000-000000001042', 'a0000000-0000-4000-8000-000000000001', '2026-09-20', 'pre_trip', '2026-09-20 06:14+00', 'fail', 15218, 'e0000000-0000-4000-8000-000000000102', 'New driver-door scrape vs last night.', 'compared', 'damage-clip-v1', '2026-09-20 06:16+00'),
  ('e0000000-0000-4000-8000-000000000201', 'c0000000-0000-4000-8000-000000000002', 'b0000000-0000-4000-8000-000000001088', 'a0000000-0000-4000-8000-000000000001', '2026-09-10', 'pre_trip', '2026-09-10 06:22+00', 'pass', 18420, null, 'Windshield chip noted.', 'skipped', null, null),
  ('e0000000-0000-4000-8000-000000000202', 'c0000000-0000-4000-8000-000000000002', 'b0000000-0000-4000-8000-000000001088', 'a0000000-0000-4000-8000-000000000001', '2026-09-17', 'pre_trip', '2026-09-17 06:20+00', 'fail', 19110, 'e0000000-0000-4000-8000-000000000201', 'Chip opened into a crack.', 'compared', 'damage-clip-v1', '2026-09-17 06:23+00'),
  ('e0000000-0000-4000-8000-000000000401', 'c0000000-0000-4000-8000-000000000004', 'b0000000-0000-4000-8000-000000001177', 'a0000000-0000-4000-8000-000000000002', '2026-09-18', 'pre_trip', '2026-09-18 06:28+00', 'pass', 26840, null, 'David on EV-213. Passenger door clean.', 'skipped', null, null),
  ('e0000000-0000-4000-8000-000000000402', 'c0000000-0000-4000-8000-000000000004', 'b0000000-0000-4000-8000-000000001156', 'a0000000-0000-4000-8000-000000000002', '2026-09-19', 'pre_trip', '2026-09-19 07:36+00', 'fail', 27105, 'e0000000-0000-4000-8000-000000000401', 'Passenger-door dent not on David DVIC.', 'compared', 'damage-clip-v1', '2026-09-19 07:38+00'),
  ('e0000000-0000-4000-8000-000000000901', 'c0000000-0000-4000-8000-000000000009', 'b0000000-0000-4000-8000-000000001224', 'a0000000-0000-4000-8000-000000000003', '2026-09-17', 'pre_trip', '2026-09-17 06:24+00', 'pass', 42880, null, 'Ama on EV-218. Rear bumper clear.', 'skipped', null, null),
  ('e0000000-0000-4000-8000-000000000902', 'c0000000-0000-4000-8000-000000000009', 'b0000000-0000-4000-8000-000000001238', 'a0000000-0000-4000-8000-000000000003', '2026-09-18', 'post_trip', '2026-09-18 19:10+00', 'fail', 43220, 'e0000000-0000-4000-8000-000000000901', 'New rear-bumper scrape after Tyler route.', 'compared', 'damage-clip-v1', '2026-09-18 19:12+00'),
  ('e0000000-0000-4000-8000-000000000903', 'c0000000-0000-4000-8000-000000000009', 'b0000000-0000-4000-8000-000000001238', 'a0000000-0000-4000-8000-000000000003', '2026-09-20', 'pre_trip', '2026-09-20 06:31+00', 'fail', 43610, 'e0000000-0000-4000-8000-000000000902', 'Scrape opened into a dent.', 'compared', 'damage-clip-v1', '2026-09-20 06:33+00'),
  ('e0000000-0000-4000-8000-000000001401', 'c0000000-0000-4000-8000-000000000014', 'b0000000-0000-4000-8000-000000001294', 'a0000000-0000-4000-8000-000000000005', '2026-09-11', 'pre_trip', '2026-09-11 06:16+00', 'pass', 61840, null, 'Chris last clean inspection.', 'skipped', null, null),
  ('e0000000-0000-4000-8000-000000001402', 'c0000000-0000-4000-8000-000000000014', 'b0000000-0000-4000-8000-000000001308', 'a0000000-0000-4000-8000-000000000005', '2026-09-12', 'pre_trip', '2026-09-12 11:20+00', 'fail', 61905, 'e0000000-0000-4000-8000-000000001401', 'Left-quarter dent after contact.', 'compared', 'damage-clip-v1', '2026-09-12 11:25+00'),
  ('e0000000-0000-4000-8000-000000001501', 'c0000000-0000-4000-8000-000000000015', 'b0000000-0000-4000-8000-000000001088', 'a0000000-0000-4000-8000-000000000001', '2026-09-17', 'pre_trip', '2026-09-17 06:40+00', 'pass', 41080, null, 'Kwame on spare EV-224.', 'skipped', null, null),
  ('e0000000-0000-4000-8000-000000001502', 'c0000000-0000-4000-8000-000000000015', 'b0000000-0000-4000-8000-000000001042', 'a0000000-0000-4000-8000-000000000001', '2026-09-18', 'pre_trip', '2026-09-18 06:12+00', 'fail', 41220, 'e0000000-0000-4000-8000-000000001501', 'Rear quarter crushed. OOS.', 'compared', 'damage-clip-v1', '2026-09-18 06:15+00'),
  ('e0000000-0000-4000-8000-000000000701', 'c0000000-0000-4000-8000-000000000007', 'b0000000-0000-4000-8000-000000001210', 'a0000000-0000-4000-8000-000000000003', '2026-09-08', 'pre_trip', '2026-09-08 06:10+00', 'fail', 37040, null, 'Left mirror housing cracked.', 'skipped', null, null),
  ('e0000000-0000-4000-8000-000000000702', 'c0000000-0000-4000-8000-000000000007', 'b0000000-0000-4000-8000-000000001210', 'a0000000-0000-4000-8000-000000000003', '2026-09-12', 'pre_trip', '2026-09-12 06:12+00', 'pass', 37170, 'e0000000-0000-4000-8000-000000000701', 'Mirror replaced. Cleared.', 'compared', 'damage-clip-v1', '2026-09-12 06:14+00');

insert into public.vehicle_damage_events (
  id, vehicle_id, station_id, dvic_id, prior_dvic_id, parent_event_id, zone, damage_type, severity, previous_severity, status, detected_via,
  first_seen_at, last_seen_at, description, estimated_cost, responsible_driver_id, prior_driver_id, next_driver_id, maintenance_order_id,
  route_id, severity_score, workflow_status, investigation_status, grounding_recommended, grounding_reason
) values
  ('f0000000-0000-4000-8000-000000000001', 'c0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000001', 'e0000000-0000-4000-8000-000000000103', 'e0000000-0000-4000-8000-000000000102', null, 'driver_door', 'scrape', 'minor', null, 'new', 'new_vs_prior', '2026-09-20 06:14+00', '2026-09-20 06:14+00', 'Fresh scrape on driver door. Absent on last night post-trip.', 420, 'b0000000-0000-4000-8000-000000001088', 'b0000000-0000-4000-8000-000000001088', 'b0000000-0000-4000-8000-000000001042', null, 'd0000000-0000-4000-8000-000000000014', 'minor', 'new', 'open', false, null),
  ('f0000000-0000-4000-8000-000000000002', 'c0000000-0000-4000-8000-000000000009', 'a0000000-0000-4000-8000-000000000003', 'e0000000-0000-4000-8000-000000000902', 'e0000000-0000-4000-8000-000000000901', null, 'rear_bumper', 'scrape', 'minor', null, 'progressing', 'new_vs_prior', '2026-09-18 19:10+00', '2026-09-20 06:31+00', 'Rear bumper scrape after Ama clean pre-trip.', 280, 'b0000000-0000-4000-8000-000000001238', 'b0000000-0000-4000-8000-000000001224', 'b0000000-0000-4000-8000-000000001238', (select id from public.maintenance_orders where work_order = 'WO-4382'), 'd0000000-0000-4000-8000-000000000027', 'moderate', 'approved', 'pending_driver', false, null),
  ('f0000000-0000-4000-8000-000000000022', 'c0000000-0000-4000-8000-000000000009', 'a0000000-0000-4000-8000-000000000003', 'e0000000-0000-4000-8000-000000000903', 'e0000000-0000-4000-8000-000000000902', 'f0000000-0000-4000-8000-000000000002', 'rear_bumper', 'dent', 'moderate', 'minor', 'progressing', 'progression', '2026-09-20 06:31+00', '2026-09-20 06:31+00', 'Same bumper zone now dented.', 940, 'b0000000-0000-4000-8000-000000001238', 'b0000000-0000-4000-8000-000000001238', 'b0000000-0000-4000-8000-000000001238', (select id from public.maintenance_orders where work_order = 'WO-4382'), 'd0000000-0000-4000-8000-000000000027', 'severe', 'under_review', 'pending_driver', true, 'Progressed bumper dent. Hold EV-218 after wave for shop.'),
  ('f0000000-0000-4000-8000-000000000003', 'c0000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000001', 'e0000000-0000-4000-8000-000000000201', null, null, 'windshield', 'chip', 'minor', null, 'progressing', 'driver_reported', '2026-09-10 06:22+00', '2026-09-17 06:20+00', 'Stone chip in wiper sweep.', 185, 'b0000000-0000-4000-8000-000000001088', null, 'b0000000-0000-4000-8000-000000001088', null, 'd0000000-0000-4000-8000-000000000022', 'minor', 'under_review', 'cleared', false, null),
  ('f0000000-0000-4000-8000-000000000033', 'c0000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000001', 'e0000000-0000-4000-8000-000000000202', 'e0000000-0000-4000-8000-000000000201', 'f0000000-0000-4000-8000-000000000003', 'windshield', 'crack', 'moderate', 'minor', 'progressing', 'progression', '2026-09-17 06:20+00', '2026-09-20 06:19+00', 'Chip propagated into a crack.', 890, 'b0000000-0000-4000-8000-000000001088', 'b0000000-0000-4000-8000-000000001088', 'b0000000-0000-4000-8000-000000001088', null, 'd0000000-0000-4000-8000-000000000022', 'severe', 'approved', 'cleared', false, 'Crack in wiper sweep. Schedule glass; van can finish today''s wave.'),
  ('f0000000-0000-4000-8000-000000000004', 'c0000000-0000-4000-8000-000000000015', 'a0000000-0000-4000-8000-000000000001', 'e0000000-0000-4000-8000-000000001502', 'e0000000-0000-4000-8000-000000001501', null, 'right_quarter', 'dent', 'major', null, 'new', 'new_vs_prior', '2026-09-18 06:12+00', '2026-09-18 06:12+00', 'Rear quarter crushed vs Kwame spare DVIC.', 4180, 'b0000000-0000-4000-8000-000000001088', 'b0000000-0000-4000-8000-000000001088', 'b0000000-0000-4000-8000-000000001042', (select id from public.maintenance_orders where work_order = 'WO-4418'), null, 'ground_vehicle', 'scheduled_repair', 'charged', true, 'Right quarter crushed. EV-224 already OOS — keep grounded until Penske releases.'),
  ('f0000000-0000-4000-8000-000000000005', 'c0000000-0000-4000-8000-000000000014', 'a0000000-0000-4000-8000-000000000005', 'e0000000-0000-4000-8000-000000001402', 'e0000000-0000-4000-8000-000000001401', null, 'left_quarter', 'dent', 'major', null, 'stable', 'shop', '2026-09-12 11:20+00', '2026-09-20 06:20+00', 'Left-quarter dent. Chris had last clean DVIC.', 1860, 'b0000000-0000-4000-8000-000000001308', 'b0000000-0000-4000-8000-000000001294', 'b0000000-0000-4000-8000-000000001308', (select id from public.maintenance_orders where work_order = 'WO-4421'), null, 'ground_vehicle', 'scheduled_repair', 'charged', true, 'Collision quarter panel + DVIC fail. Do not launch EV-223.'),
  ('f0000000-0000-4000-8000-000000000006', 'c0000000-0000-4000-8000-000000000004', 'a0000000-0000-4000-8000-000000000002', 'e0000000-0000-4000-8000-000000000402', 'e0000000-0000-4000-8000-000000000401', null, 'passenger_door', 'dent', 'moderate', null, 'new', 'new_vs_prior', '2026-09-19 07:36+00', '2026-09-20 07:38+00', 'Passenger-door dent after David clean DVIC.', 760, 'b0000000-0000-4000-8000-000000001156', 'b0000000-0000-4000-8000-000000001177', 'b0000000-0000-4000-8000-000000001156', (select id from public.maintenance_orders where work_order = 'WO-4390'), 'd0000000-0000-4000-8000-000000000031', 'moderate', 'under_review', 'open', false, null),
  ('f0000000-0000-4000-8000-000000000007', 'c0000000-0000-4000-8000-000000000007', 'a0000000-0000-4000-8000-000000000003', 'e0000000-0000-4000-8000-000000000701', null, null, 'mirror_left', 'crack', 'moderate', null, 'resolved', 'driver_reported', '2026-09-08 06:10+00', '2026-09-12 06:12+00', 'Left mirror replaced with camera recall.', 310, 'b0000000-0000-4000-8000-000000001210', null, 'b0000000-0000-4000-8000-000000001210', (select id from public.maintenance_orders where work_order = 'WO-4334'), 'd0000000-0000-4000-8000-000000000011', 'moderate', 'repaired', 'closed', false, null);

insert into public.damage_photos (
  damage_event_id, dvic_id, vehicle_id, zone, captured_at, captured_by_driver_id, storage_bucket, storage_path, content_hash, width_px, height_px, camera_angle, is_baseline, embedding_status, embedding_model, embedding_dims, embedding_ref, compared_to_photo_id, similarity_score, change_confidence, ai_notes
) values
  ('f0000000-0000-4000-8000-000000000001', 'e0000000-0000-4000-8000-000000000102', 'c0000000-0000-4000-8000-000000000001', 'driver_door', '2026-09-19 18:42+00', 'b0000000-0000-4000-8000-000000001088', 'dsp-dvic-photos', 'vehicles/van-01/2026-09-19/driver_door-ph-01a.jpg', 'sha256:ph-01a', 1600, 1200, 'left', true, 'ready', 'damage-clip-v1', 768, 'vec://dsp-dvic-photos/ph-01a', null, null, null, 'Baseline door panel.'),
...
insert into public.damage_reviews (damage_event_id, reviewed_at, reviewer_name, reviewer_role, decision, assigned_driver_id, notes) values
  ...
  ('f0000000-0000-4000-8000-000000000022', '2026-09-20 07:20+00', 'Jordan Hale', 'operations_manager', 'confirm_progression', 'b0000000-0000-4000-8000-000000001238', 'Bumper worsened under Tyler.'),
  ('f0000000-0000-4000-8000-000000000004', '2026-09-18 08:10+00', 'Riley Cho', 'safety_manager', 'send_to_shop', 'b0000000-0000-4000-8000-000000001088', 'OOS Penske WO-4418.'),
  ('f0000000-0000-4000-8000-000000000006', '2026-09-20 08:00+00', 'Jordan Hale', 'operations_manager', 'confirm_new', 'b0000000-0000-4000-8000-000000001156', 'David 09-18 clean. Sofia accountable.');

insert into public.maintenance_repairs (
  damage_event_id, maintenance_order_id, vehicle_id, station_id, vendor, repair_type, status, quoted_cost, actual_cost, scheduled_date, completed_date, notes
) values
  ('f0000000-0000-4000-8000-000000000004', (select id from public.maintenance_orders where work_order = 'WO-4418'), 'c0000000-0000-4000-8000-000000000015', 'a0000000-0000-4000-8000-000000000001', 'Penske Collision DLA7', 'body', 'in_progress', 4180, null, '2026-09-18', null, 'Quarter panel + sensor cluster.'),
  ('f0000000-0000-4000-8000-000000000005', (select id from public.maintenance_orders where work_order = 'WO-4421'), 'c0000000-0000-4000-8000-000000000014', 'a0000000-0000-4000-8000-000000000005', 'Amazon Fleet Shop DCH1', 'body', 'approved', 1860, null, '2026-09-20', null, 'Held with brake/tire DVIC fail.'),
  ('f0000000-0000-4000-8000-000000000007', (select id from public.maintenance_orders where work_order = 'WO-4334'), 'c0000000-0000-4000-8000-000000000007', 'a0000000-0000-4000-8000-000000000003', 'Ford Commercial Seattle', 'mirror', 'completed', 310, 0, '2026-09-12', '2026-09-12', 'Warranty / camera recall.'),
  ('f0000000-0000-4000-8000-000000000033', null, 'c0000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000001', 'Safelite DLA7', 'glass', 'quoted', 890, null, '2026-09-21', null, 'Windshield replacement quote.');
