...
/** Station clock date. Matches MOCK_NOW (2026-09-24). */
export const STATION_TODAY = "2026-09-24";

/** Seven days ending on the station clock, inclusive. */
export const STATION_WEEK_START = "2026-09-18";
export const STATION_WEEK_END = "2026-09-24";
